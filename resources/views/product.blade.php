                ...
                @foreach($produkUnggulan as $produk)
                    <div class="bg-white dark:bg-dark rounded-lg md:rounded-xl shadow-md overflow-hidden border border-gray-100 dark:border-gray-700 relative
                        ...
                        <div class="p-3 md:p-5">
                            ...
                            <p class="text-primary font-bold mt-2 text-md md:text-lg dark:text-primary-light">{{ $produk->harga }}</p>
        ...
        <section class="mt-20">
            ...
            <form method="GET" class="mt-8 mb-8 p-6 bg-white dark:bg-dark rounded-xl shadow-md border border-gray-100 dark:border-gray-700
                ...
                <div class="flex-grow">
                    ...
                    <input type="text" name="search" id="search" placeholder="Ketik nama produk..." value="{{ request('search') }}"
                ...
                <button type="submit" class="bg-primary text-white px-6 py-2 rounded-lg hover:bg-primary-dark transition h-fit self-end">
                    Terapkan
                </button>
            </form>
